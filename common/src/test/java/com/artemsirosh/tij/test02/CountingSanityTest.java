...
public class CountingSanityTest {
    ...
    private final static String ASCII_SAMPLE = "./src/main/resources/asci.sample";
    private final static String NOT_ASCII_SAMPLE = "./src/main/resources/n_asci.sample";
    private final static String LARGE_SAMPLE = "./src/main/resources/large.sample";
    ...
    * data.txt - large sample file*/
    ...
    public void countingTimeMeasureTest() throws Exception {
        // input samples
        char[] soughtCharacters = "onvMus는절에수ступТвон".toCharArray();
        String targetPath = "./src/main/resources/asci.sample";
